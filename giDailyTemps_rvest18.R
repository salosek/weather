...
dtab <- read_html("https://www.accuweather.com/en/us/grand-island-ne/68801/february-weather/329504?monyr=2/1/2018&view=table")
tab <- html_nodes(dtab, css = "table")
tab02 <- html_table(tab, fill = TRUE, header = FALSE)[[1]]
tab02 <- tab02[-c(1),] 

dtab <- read_html("https://www.accuweather.com/en/us/grand-island-ne/68801/march-weather/329504?monyr=3/1/2018&view=table")
tab <- html_nodes(dtab, css = "table")
tab03 <- html_table(tab, fill = TRUE, header = FALSE)[[1]]
tab03 <- tab03[-c(1),] 

dtab <- read_html("https://www.accuweather.com/en/us/grand-island-ne/68801/april-weather/329504?monyr=4/1/2018&view=table")
tab <- html_nodes(dtab, css = "table")
tab04 <- html_table(tab, fill = TRUE, header = FALSE)[[1]]
tab04 <- tab04[-c(1),] 

dtab <- read_html("https://www.accuweather.com/en/us/grand-island-ne/68801/may-weather/329504?monyr=5/1/2018&view=table")
tab <- html_nodes(dtab, css = "table")
tab05 <- html_table(tab, fill = TRUE, header = FALSE)[[1]]
tab05 <- tab05[-c(1),] 

dtab <- read_html("https://www.accuweather.com/en/us/grand-island-ne/68801/june-weather/329504?monyr=6/1/2018&view=table")
tab <- html_nodes(dtab, css = "table")
tab06 <- html_table(tab, fill = TRUE, header = FALSE)[[1]]
tab06 <- tab06[-c(1),] 

dtab <- read_html("https://www.accuweather.com/en/us/grand-island-ne/68801/july-weather/329504?monyr=7/1/2018&view=table")
tab <- html_nodes(dtab, css = "table")
tab07 <- html_table(tab, fill = TRUE, header = FALSE)[[1]]
tab07 <- tab07[-c(1),] 

dtab <- read_html("https://www.accuweather.com/en/us/grand-island-ne/68801/august-weather/329504?monyr=8/1/2018&view=table")
tab <- html_nodes(dtab, css = "table")
tab08 <- html_table(tab, fill = TRUE, header = FALSE)[[1]]
tab08 <- tab08[-c(1),] 

dtab <- read_html("https://www.accuweather.com/en/us/grand-island-ne/68801/september-weather/329504?monyr=9/1/2018&view=table")
tab <- html_nodes(dtab, css = "table")
tab09 <- html_table(tab, fill = TRUE, header = FALSE)[[1]]
tab09 <- tab09[-c(1),] 

dtab <- read_html("https://www.accuweather.com/en/us/grand-island-ne/68801/october-weather/329504?monyr=10/1/2018&view=table")
tab <- html_nodes(dtab, css = "table")
tab10 <- html_table(tab, fill = TRUE, header = FALSE)[[1]]
tab10 <- tab10[-c(1),] 

dtab <- read_html("https://www.accuweather.com/en/us/grand-island-ne/68801/november-weather/329504?monyr=11/1/2018&view=table")
tab <- html_nodes(dtab, css = "table")
tab11 <- html_table(tab, fill = TRUE, header = FALSE)[[1]]
tab11 <- tab11[-c(1),] 

dtab <- read_html("https://www.accuweather.com/en/us/grand-island-ne/68801/december-weather/329504?monyr=12/1/2018&view=table")
tab <- html_nodes(dtab, css = "table")
...
gitab$Date <- paste(gitab$Date,"/2018")
...
write.csv(gitab, "./data/2018GIWeather_forecast.csv", row.names=FALSE)
gitab$Forecast <- NULL
write.csv(gitab, "./data/2018GIWeather.csv", row.names=FALSE)
write.xlsx(gitab, file = "./data/2018GIWeather99.xlsx", rowNames=FALSE, colNames = TRUE)

print(gitab[1:31,])      ## Jan 1:31, Feb 32:59, Mar 60:90, Apr 91:120, May 121:151, Jun 152:181
                          ## Jul 182:212, Aug 213:243, Sep 244:273, Oct 274:304, Nov 305:334, Dec 335:365
cat("\n")
print(paste(Sys.Date(), weekdays(Sys.Date())))
